...
class SupervisorProtocolTests(unittest.TestCase):
    ...
    def test_chat_model_download_requires_revision_and_delegates(self):
        request_id = str(uuid.uuid4())
        with tempfile.TemporaryDirectory() as directory:
            base = Path(directory)
            cache = base / "cache"
