...
- REMAINING: provider-native session resume (requires a separately approved real-provider probe), confirmation/audit integration above the adapter boundary, persistent recovery/task-history storage (P7-T02), and replacement of Preview cards with runtime data (P3-T16) remain open.
