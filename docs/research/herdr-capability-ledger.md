...
- REMAINING: provider-native session resume, detach/reconnect across a user-owned lifecycle, confirmation/audit integration above the adapter boundary, and replacement of Preview cards with runtime data remain P3-T15+.
