...
- REMAINING: real wait/blocked/artifact-read, forced termination, provider-native session resume, detach/reconnect, confirmation policy levels, and replacement of preview cards with runtime data remain P3-T14+.
